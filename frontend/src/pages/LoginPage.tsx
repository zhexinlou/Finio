    ...
    <div className="min-h-screen bg-gray-50 flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-[#1e3a5f] text-white flex-col justify-between p-12">
        ...
        <div>
          ...
          <p className="text-white/60 text-sm leading-relaxed max-w-md">
            智能对话、自动报表、团队协作 —— Finio
            为企业提供一站式财务AI解决方案，让财务工作更高效、更智能。
          </p>
        </div>
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          ...
          <p className="text-sm text-gray-400 mb-8">登录你的 Finio 账户</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <div className="flex items-center justify-between mb-1">
                ...
                <Link to="/forgot-password" className="text-xs text-[#1e3a5f] hover:underline">
                  忘记密码？
                </Link>
              </div>
